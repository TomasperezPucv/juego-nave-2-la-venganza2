...
corazones[0] = instance_create_layer(x+10,y+38,  "UI", obj_heart);
corazones[1] = instance_create_layer(x+46,y+38,  "UI", obj_heart);
corazones[2] = instance_create_layer(x+84,y+38,  "UI", obj_heart);
